...
const CheckoutForm = () => {
    ...
    let data_shipping_fee=shipping_fee *100;
    let data_total_amount=total_price*100;
    ...
    try {
      const { data } = await axios.post(
        ...
        {"cart":cart,"shipping_fee":data_shipping_fee,"total_amount":data_total_amount}
      )
      ...
      <form id='payment-form' onSubmit={handleSubmit}>
          ...
          <button disabled={processing || disabled || succeeded } id='submit'>
              ...
              <p className={succeeded ? 'result-message': 'result-message hidden'}>
                  Payment succeded,see the result in your <a href={`https://dashboard.stripe.com/test/payments`}>Stripe dashboard</a>
                  </p>
          </form>
